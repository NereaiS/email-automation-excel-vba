...
- `documents/` : documents PDF fictifs de démonstration
- `captures d’écran/` : captures de l’interface

## Captures
### Interface Excel
![Interface Excel](captures d’écran/excel-interface.png)

### Résultat dans Outlook
![Mail reçu dans Outlook](captures d’écran/outlook-mail-recu.png)
